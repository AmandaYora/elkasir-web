// Package presentation holds the category module's HTTP handlers and routes.
...
// Routes mounts /categories (admin-only; writes = owner/admin, viewer read-only).
...
func (h *Handler) create(w http.ResponseWriter, r *http.Request) {
	...
	httpx.Created(w, dto, "Kategori berhasil dibuat")
}
...
func (h *Handler) update(w http.ResponseWriter, r *http.Request) {
	...
	httpx.OK(w, dto, "Kategori berhasil diperbarui")
}
