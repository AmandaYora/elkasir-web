...
func Unauthorized(msg string) *APIError  { return newErr(http.StatusUnauthorized, CodeUnauthorized, msg) }
...
func RateLimited(msg string) *APIError { return newErr(http.StatusTooManyRequests, CodeRateLimited, msg) }
