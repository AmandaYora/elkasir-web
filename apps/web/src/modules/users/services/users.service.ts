...
import type { AdminUser, AdminCreateInput, AdminUpdateInput } from "@/modules/users/types/user.types";
...
export const usersService = {
  ...
  update: (id: string, body: AdminUpdateInput) => api.put<AdminUser>(`${endpoints.adminUsers}/${id}`, body),
